...
<div class="row"><%--
	...
	<form:form class="form-inline col-xs-12 col-sm-6" action="${accountsUrl}" modelAttribute="accountSearchCriteria" method="get">
...
<table class="table">
	...
	<c:forEach var="account" items="${accounts}">
		<tr>
			<td>
				<spring:url var="accountUrl" value="accounts/{number}">
					<spring:param name="number" value="${account.number}" />
				</spring:url>
				<a href="${accountUrl}">${account.number}</a>
